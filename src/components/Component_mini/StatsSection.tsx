          ...
          {data.map((stat, index) => (
            ...
            >
              ...
              {typeof stat.value === "number" && (
                <>
                  <div className=" notranslate w-12 h-12 rounded-xl bg-gradient-to-br from-primary/20 to-accent/20 flex items-center justify-center mb-2 transition-transform group-hover:scale-110">
                    <stat.icon className="w-6 h-6 text-primary" />
                  </div>

                  {/* Number Value */}
                  <div className="text-2xl md:text-3xl font-bold mb-1 notranslate">

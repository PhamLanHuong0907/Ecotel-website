...
export const HeroSection = () => {
      ...
      <div className="w-full  mx-auto px-4 relative z-10 mt-16">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-[60px]">
            <span className="gradient-text">Kho dữ liệu tập trung </span>
  ...
  <p className="text-lg leading-relaxed">
    <span className="text-primary font-semibold">
      Giải pháp Data Lakehouse được thiết kế với mục đích đồng bộ dữ liệu tại một nơi duy nhất, đóng vai trò nền tảng để khai thác tối đa giá trị dữ liệu trong quá trình chuyển đổi số của doanh nghiệp.
    </span>
  </p>
  <p className="text-muted-foreground leading-relaxed text-[19px]">
    Hệ thống cung cấp khả năng lưu trữ linh hoạt, hỗ trợ đắc lực cho AI/ML và phân tích dữ liệu lớn, đảm bảo dữ liệu luôn sạch, có cấu trúc và dễ dàng truy xuất cho các chuyên gia dữ liệu.

...
export const HeroSection = () => {
  ...
  return (
      ...
      <div className="w-full  mx-auto px-4 relative z-10 mt-16">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-[60px]">
            <span className="gradient-text">Phần mềm Quản lý hiệu suất thiết bị (OEE) </span>
    ...
    <p className="text-primary font-semibold text-[19px] leading-relaxed">
       Đánh giá sức khỏe dây chuyền sản xuất minh bạch dựa trên bộ ba chỉ số vàng: <br/>Availability – Performance – Quality.
    </p>
    <p className="text-muted-foreground leading-relaxed text-[19px]">
       Để cải thiện năng suất, trước tiên cần hiểu rõ nguồn gốc của sự sụt giảm. Phần mềm giúp số hóa việc tính toán OEE, tự động chỉ ra các điểm nghẽn trong vận hành mà mắt thường khó nhận thấy. Dựa trên dữ liệu phân tích này, nhà quản lý có cơ sở vững chắc để đưa ra các quyết định bảo trì dự đoán và cải tiến quy trình, đảm bảo thiết bị luôn hoạt động ở trạng thái lý tưởng nhất.
    </p>
</div>
        </motion.div>
      </div>

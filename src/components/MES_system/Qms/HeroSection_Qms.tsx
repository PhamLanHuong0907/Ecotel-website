...
export const HeroSection = () => {
  ...
  return (
      ...
      <div className="w-full  mx-auto px-4 relative z-10 mt-16">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-[60px]">
            <span className="gradient-text">Quản lý chất lượng (QMS)</span>
    ...
    <p className="text-primary font-semibold text-[21px] leading-relaxed">
       Số hóa quy trình quản lý chất lượng (QMS): <br/>Kiểm soát toàn diện, Giảm thiểu sai lỗi và Nâng cao uy tín thương hiệu.
    </p>
    <p className="text-muted-foreground leading-relaxed text-[19px]">
       ECOTEL cung cấp công cụ giám sát chất lượng xuyên suốt vòng đời sản xuất. Từ việc kiểm định nguyên liệu đầu vào đến nghiệm thu thành phẩm, hệ thống đảm bảo mọi khâu đều đáp ứng tiêu chuẩn kỹ thuật, giúp doanh nghiệp tự tin cam kết chất lượng tốt nhất với khách hàng.
    </p>
</div>
        </motion.div>
      </div>

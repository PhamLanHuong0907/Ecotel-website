...
export const HeroSection = () => {
  ...
  <p className="text-primary font-semibold text-[19px] leading-relaxed">
    Trung tâm điều hành thông minh SOC (Smart Operation Center) đóng vai trò là "bộ não" số hóa, tích hợp và tổng hợp dữ liệu từ đa nguồn như IoT, Drone, AI, và hệ thống cảm biến để tạo nên một nền tảng quản trị nhất quán.
  </p>
  <p className="text-muted-foreground leading-relaxed text-[19px]">
    Ứng dụng sức mạnh của Big Data và AI, hệ thống không chỉ giám sát và dự báo xu hướng vận hành mà còn cung cấp các bảng điều khiển trực quan (Dashboard) theo thời gian thực. 

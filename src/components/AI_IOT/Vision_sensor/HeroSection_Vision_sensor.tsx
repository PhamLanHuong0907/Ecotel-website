...
export const HeroSection = () => {
      ...
      <div className="w-full  mx-auto px-4 relative z-10 mt-16">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-[60px]">
            <span className="gradient-text">Cảm biến hình ảnh với AI tích hợp</span>
  ...
  <p className="text-primary font-semibold text-[19px] leading-relaxed">
    Cảm biến hình ảnh với AI tích hợp là giải pháp kiểm định chất lượng (QA/QC) thế hệ mới, được thiết kế chuyên biệt để giải quyết triệt để những thách thức phức tạp nhất trong quy trình phát hiện và kiểm tra lỗi sản phẩm.
  </p>
  <p className="text-muted-foreground leading-relaxed text-[19px]">
    Sử dụng dòng thiết bị IV4 tiên tiến, hệ thống sở hữu khả năng "tư duy" để tự động xác định, phân loại, đếm số lượng và đọc ký tự (OCR) với độ chính xác cao mà không chịu ảnh hưởng bởi môi trường. 

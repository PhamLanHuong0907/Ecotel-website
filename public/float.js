...
(function(){
    ...
    // --- MODIFIED CSS HERE (Dark background, rounded corners, smaller font, white text) ---
    widget_css += '.gt_float_switcher{font-family:Arial;font-size:14px;border-radius:10px;color:#fff;display:inline-block;line-height:20px;box-shadow:rgba(0,0,0,0.5) 0 4px 12px;background:linear-gradient(145deg, hsl(155 42% 12% / 0.8) 0%, hsl(155 42% 9% / 0.6) 100%);overflow:hidden;transition:all .5s cubic-bezier(0.4, 0, 1, 1)}';
    widget_css += '.gt_float_switcher img{vertical-align:middle;display:inline-block;width:24px;height:auto;margin:0 5px 0 0;border-radius:2px}'; // Reduced image size slightly
    ...
    if(float_switcher_open_direction == 'left' || float_switcher_open_direction == 'right') {
        ...
        widget_css += '.gt_float_switcher .gt_options a{display:inline-block;text-decoration:none;padding:'+(flag_style=='3d'?4:8)+'px 10px;color:#fff;transition:color .4s linear}';
        widget_css += '.gt_float_switcher .gt-selected{position:relative;z-index:888;background-color:linear-gradient(145deg, hsl(155 42% 12% / 0.8) 0%, hsl(155 42% 9% / 0.6) 100%);float:left;cursor:pointer;text-transform:uppercase;overflow:hidden;'+(switcher_horizontal_position != 'inline' && 'text-align:'+switcher_horizontal_position)+'}';
    } else {
        ...
        // Reduced padding here
        widget_css += '.gt_float_switcher .gt_options a{display:block;text-decoration:none;padding:'+(flag_style=='3d'?4:8)+'px 10px;color:#fff;transition:color .4s linear}';
        widget_css += '.gt_float_switcher .gt-selected{position:relative;z-index:888;background-color:linear-gradient(145deg, hsl(155 42% 12% / 0.8) 0%, hsl(155 42% 9% / 0.6) 100%);cursor:pointer;text-transform:uppercase;overflow:hidden;'+(switcher_horizontal_position != 'inline' && 'text-align:'+switcher_horizontal_position)+'}';
    }
    widget_css += '.gt_float_switcher .gt_options.gt-open{opacity:1;transform:translateX(0px)}';

    widget_css += '.gt_float_switcher .gt_options::-webkit-scrollbar-track{background-color:#333}';
    ...
    widget_css += '.gt_float_switcher .gt_options a:hover{background:#404040;color:#fff}'; // Darker hover
    widget_css += '.gt_float_switcher .gt_options a.gt-current{display:none}';
    // Reduced padding and Bold Text
    widget_css += '.gt_float_switcher .gt-selected .gt-current-lang{padding:'+(flag_style=='3d'?4:8)+'px 10px;color:#fff;font-weight:bold}';
    ...
    // Changed SVG arrow color from #666 to #ffffff
    ...
    if(switcher_horizontal_position == 'inline')
        ...
        // Keeps your previous logic for height
        var vertical_dist = (switcher_vertical_position == 'bottom') ? '100px' : '20px';
        widget_code += '<div id="gt_float_wrapper" style="position:fixed;'+switcher_vertical_position+':'+vertical_dist+';'+switcher_horizontal_position+':30px;z-index:999999;"><div class="gt_float_switcher notranslate" style="opacity:0">';
    }
